...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-154427921-1"></script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-item nav-link" href="<?php echo url ;?>/mostrarCarrito.php">Carrito(<?php echo $num;?>)</a>
                </div>
            </div>
        </div>
    </nav>
