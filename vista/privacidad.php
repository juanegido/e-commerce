...
<div class="container">
    ...
    <h3>Identificación y Titularidad</h1>
    ...
    <div class="container">
        <ul>
            <li type="circle"> Titular: Nombre y apellidos o razón social. </li>
            <li type="circle"> Registro mercantil:  Datos de la inscripción en el Registro mercantil (sociedades).  </li>
            <li type="circle"> Título académico oficial, datos del colegio profesional y número de colegiado (si ejereces una profesión regulada).    </li>
            <li type="circle"> NIF:  B1234U9O3 </li>
            <li type="circle"> Domicilio: avenida albacete, 7, Albacete .    </li>
            <li type="circle"> Correo electrónico: tachbot7@gmail.com.    </li>
            <li type="circle"> Sitio Web Tachbot.com.  </li>
        </ul>
    </div>  

    <h3>Finalidad</h3>
    <p>La finalidad del sitio Web Tachbot.com es la venta de chatbot`s.</p>
    ...
    <div class="container">
        <ul>
            <li type="circle"> Aviso Legal</li>
            <li type="circle"> Política de Privacidad  </li>
            <li type="circle"> Política de Cookies </li>
        </ul>
    </div> 
    ...
    <p>Usted debe tener al menos 18 años de edad para usar los servicios ofrecidos por el Titular o la mayoría de edad que se requiera su país para registrarse en el sitio Web o utilizarlo. Si reside en un país que no pertenezca a la Región europea, debe tener al menos 13 años de edad para usar el sitio Web o la mayoría de edad que se requiera su país para registrarse en el sitio Web o utilizarlo.</p>
    <p>Además de tener la edad mínima requerida para usar el sitio Web en virtud de la ley aplicable, si no tiene la edad suficiente para poder aceptar nuestras condiciones en su país, su padre, madre, o tutor deben aceptar nuestras condiciones en su nombre.</p>
    ...
    <div class="container">
        <ul>
            <li type="circle"> El nombre de dominio del proveedor (PSI) y/o dirección IP que les da acceso a la red.</li>
            <li type="circle"> La fecha y hora de acceso al sitio Web.</li>
            <li type="circle"> La dirección de Internet origen del enlace que dirige al sitio Web.</li>
            <li type="circle"> El número de visitantes diarios de cada sección.</li>
            <li type="circle"> La información obtenida es totalmente anónima, y en ningún caso puede ser asociada a un Usuario concreto e identificado..</li>
        </ul>
    </div> 
    ...
    <h3>Enlaces de Afiliados y anuncios patrocinados</h3>
    ...
    <p>Siempre que no haya una norma que obligue a otra cosa, para cuantas cuestiones se susciten sobre la interpretación, aplicación y cumplimiento de este Aviso Legal, así como de las reclamaciones que puedan derivarse de su uso, las partes acuerdan someterse a los Jueces y Tribunales de la provincia de Albacete, con renuncia expresa de cualquier otra jurisdicción que pudiera corresponderles.</p>

    <h3>Contacto</h3>
    <p>En caso de que usted tenga cualquier duda acerca de estas Condiciones legales o quiera realizar cualquier comentario sobre este sitio Web, puede enviar un mensaje de correo electrónico a la dirección tachbot7@gmail.com.</p>
